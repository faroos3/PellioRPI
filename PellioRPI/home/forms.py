...
class HomeForm(forms.Form):
  ...
  eighth = forms.ChoiceField(widget=forms.RadioSelect(attrs={'class': 'Radio'}), choices=[(1, 'Not at all'), (2, 'A Little'), (3, 'Moderately'), (4, 'Quite a Bit'), (5, 'Strongly')])
  ninth = forms.ChoiceField(widget=forms.RadioSelect(attrs={'class': 'Radio'}), choices=[(1, 'Not at all'), (2, 'A Little'), (3, 'Moderately'), (4, 'Quite a Bit'), (5, 'Strongly')])
  tenth = forms.ChoiceField(widget=forms.RadioSelect(attrs={'class': 'Radio'}), choices=[(1, 'Not at all'), (2, 'A Little'), (3, 'Moderately'), (4, 'Quite a Bit'), (5, 'Strongly')])
  eleventh = forms.ChoiceField(widget=forms.RadioSelect(attrs={'class': 'Radio'}), choices=[(1, 'Not at all'), (2, 'A Little'), (3, 'Moderately'), (4, 'Quite a Bit'), (5, 'Strongly')])